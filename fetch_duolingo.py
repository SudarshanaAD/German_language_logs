...
# Fetch raw public profile information from Duolingo's official API endpoint
...
if response.status_code == 200:
    ...
    # Check if a valid user array was returned
    if data.get('users'):
...
"""
        ...
        print(f"User '{DUOLINGO_USERNAME}' not found on Duolingo.")
        exit(1)
else:
